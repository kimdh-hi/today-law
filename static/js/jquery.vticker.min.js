        ...
        bindMousePausing: function (a) {
            return function (a, e) {
                return a.bind("mouseenter", function () {
                    //a.css({overflow: "hidden", height: "10em", position: "relative"})
                    if (!e.isPaused) {
                        return e.pausedByCode = !0, c.stopInterval.call(this), f.pause.call(this, !0)
                    }

                }).bind("mouseleave", function () {
                    //a.css({overflow: "hidden", height: "1.2em", position: "relative"})
